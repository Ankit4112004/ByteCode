  ...
  return (
    <div className="container mx-auto p-4 sm:p-8 max-w-7xl">
      <div className="mb-8 border-b border-white/10 pb-4">
        ...
        <p className="text-gray-400 mt-2 text-sm">Permanently remove problems from the database. This action cannot be undone.</p>
      </div>
                ...
                <tr key={problem._id} className="hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <button 
                      ...
                      className="bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white px-4 py-2 rounded-lg font-bold text-xs transition-all border border-red-500/20 hover:shadow-lg hover:shadow-red-500/20 flex items-center gap-2 ml-auto"
                    >
